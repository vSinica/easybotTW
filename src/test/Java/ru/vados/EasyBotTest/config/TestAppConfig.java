package ru.vados.EasyBotTest.config;
...
import ru.vados.easybot.Config.ServiceConfig;
import ru.vados.easybot.Config.YamlPropertySourceFactory;
...
@ComponentScan(basePackages = {"ru.vados.EasyBotTest"})
